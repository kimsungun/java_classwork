...
public class CharacterTypeTest {
	...
	public static void main(String[] args) { //char ascii 코드값을 분류합니다.(대문자, 소문자, 숫자, 특수기호)
		...
		//Scanner 로 키보드 입력할때 문자입력은 없습니다.
		int ch1;
		Scanner sc = new Scanner(System.in);
		System.out.println("알고 싶은 아스키코드 정수값 입력하세요. -> ");
		...
		//분류 : 특수기호, 범위를 체크해보세요. (문자 또는 코드값) 코드값 32 ~ 47, 58 ~ 64, 91 ~ 96, 123 ~ 126
			...
			System.out.println("분류 : 없음, 알 수 없는 문자");
...
// 연산자 우선순위 : 괄호 없이 여러개의 연산자로 수식을 만들 때  2+3*4/12
