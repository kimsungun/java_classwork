...
public class CharacterTest { // 언어별로 사용하는 문자는 컴퓨터로 처리하기 위해 문자 인코딩을 위한 문자 코드가 있습니다.
	                         // 가장 ㅁ낳이 사용하는 문자코드 : utf-8, 영문자/숫자/기호 :  ascii 코드와 같습니다.

	public static void main(String[] args) {
		// char 형식은 문자형입니다.
		
		char ch1 = 'a';  //리터럴은 작은 따옴표 사용합니다.
		char ch2 = 65;   //char 형식은 정수값으로는 0 ~ 65535 까지 저장할 수 있습니다. (2바이트)
		...
		System.out.println("ch4="+ch4);
		System.out.println("ch5="+ch5);
		System.out.println("한글코드는 모두 몇개일까요? " + (ch5-44032+1));
		
		//char 형식 데이터의 연산 : 정수데이터로 하는 연산 가능합니다.
		
	//	ch1 = ch1+1;    //오류의 이유 : ch1 = ch1+1;
