...
public class IntegerData {
	...
	public static void main(String[] args) {
		...
		// *Byte, Short, Integer, Long 클래스는 정수 데이터 형식을 다룹니다. (Wrapper 클래스 종류)
		...
		// 필드는 클래스에 속하며
		// 필드 중에서 변하지 않는 값(상수)은 일반적으로 모두 대문자로 표기합니다.
		
		System.out.println("::: 2바이트에 저장하는 Byte 정수 확인 :::");
		...
		System.out.println("::: 8바이트에 저장하는 Integer 정수 확인 :::");
